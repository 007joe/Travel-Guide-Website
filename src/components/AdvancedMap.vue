...
<html>
  <head>
    ...
    <script>
      const CONFIGURATION = {
        "locations": [
          {"title":"Mount Fuji","address1":"Mount Fuji","address2":"Kitayama, Fujinomiya, Shizuoka 418-0112, Japan","coords":{"lat":35.36065803772267,"lng":138.7274545951065},"placeId":"ChIJmcj9QppiGWAR36TzFsn8oaY"}
        ],
        "mapOptions": {"center":{"lat":38.0,"lng":-100.0},"fullscreenControl":true,"mapTypeControl":false,"streetViewControl":false,"zoom":4,"zoomControl":true,"maxZoom":17},
        "mapsApiKey": "AIzaSyCcrOUiA-7wHhNdkdczzY1PMgTFclDgYAg",
  ...
  <body>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcrOUiA-7wHhNdkdczzY1PMgTFclDgYAg&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_locatorplus_v4_cABCDE" async defer></script>
  </body>
</html>